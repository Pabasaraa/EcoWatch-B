...
def process_video(video_path, output_video_path, location, date, time, R_width_padding, L_width_padding, U_height_padding, D_height_padding):
    ...
    while True:
        ...
        frame_time = seconds_to_time_format(given_time_seconds + frame_time_seconds)
